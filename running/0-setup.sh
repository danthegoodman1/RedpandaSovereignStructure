...
cargo build --target=wasm32-unknown-unknown --release --package format --manifest-path transforms/format/Cargo.toml
mv transforms/format/target/wasm32-unknown-unknown/release/format.wasm transforms/format/
